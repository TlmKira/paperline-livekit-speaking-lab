  ...
  const pricingPlans = [
    {
      ...
      price: "$14.99",
      cadence: t("pricing.plans.monthly.cadence"),
      detail: t("pricing.plans.monthly.detail"),
      supportingText: t("pricing.plans.monthly.supportingText"),
      features: [
      ...
      href: "/signup",
      tone: "dark",
      badge: t("pricing.plans.monthly.badge"),
    },
    {
      name: t("pricing.plans.yearly.name"),
      price: "$119",
      cadence: t("pricing.plans.yearly.cadence"),
      detail: t("pricing.plans.yearly.detail"),
      supportingText: t("pricing.plans.yearly.supportingText"),
      features: [
        t("pricing.plans.yearly.feature1"),
        t("pricing.plans.yearly.feature2"),
        t("pricing.plans.yearly.feature3"),
      ],
    ...
    },
    {
      ...
      price: "$0",
      cadence: t("pricing.plans.openSource.cadence"),
      detail: t("pricing.plans.openSource.detail"),
      supportingText: t("pricing.plans.openSource.supportingText"),
      features: [
        t("pricing.plans.openSource.feature1"),
        t("pricing.plans.openSource.feature2"),
        t("pricing.plans.openSource.feature3"),
      ],
      ctaLabel: t("pricing.plans.openSource.cta"),
        ...
        <Card className="bg-transparent p-4 backdrop-blur-0 sm:p-5 lg:px-6">
          <div className="grid gap-2.5 sm:grid-cols-[1.2fr_0.8fr] sm:items-center">
            <div className="space-y-2">
              <p className="eyebrow text-sm text-sage-green">{t("pricing.eyebrow")}</p>
